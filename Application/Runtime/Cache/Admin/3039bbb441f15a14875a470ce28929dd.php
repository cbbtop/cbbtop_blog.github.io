...
<html>
	...
	<body class="ContentBody">
		<form action="<?php echo U('Product/productEdit');?>" method="post" target="_parent">
			<!-- 隐藏域 -->
			<input type="hidden" name="id" value="<?php echo ($info['id']); ?>" /><!--传父类的ID(pid)-->
			<input type="hidden" name="path" value="<?php echo ($info['path']); ?>" /><!--传路径-->
			<div>
				<table  class="table table-border table-bordered table-hover">
					<tr>
						<td class="text-c f-16" >修改分类名:</td>
				...
				<input type="submit" value="修改" class="btn btn-success radius"/>　
