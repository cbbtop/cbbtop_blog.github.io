    ...
    <form class="form form-horizontal" action="<?php echo U('Login/login');?>" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input name="user_name" type="text" placeholder="用户名" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">本站由博主自主搭建 © 2016-2017 www.cbbtop.com 版权所有 ICP证：粤ICP备17021590号-1
联系邮箱：cbbtop@163.com 钟伟建个人博客后台管理系统</div>
