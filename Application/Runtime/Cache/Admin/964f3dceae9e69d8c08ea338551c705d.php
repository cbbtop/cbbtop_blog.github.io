...
<div class="page-container">
	<form action="<?php echo U('Product/productListAdd');?>" target="_parent" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="article_name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="article_des" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="" onKeyUp="$.Huitextarealength(this,200)"></textarea>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章的模式：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
		...
		<!-- <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">图片详情描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="img_desc">
			</div>
		</div> -->
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="myEditor" name="article_content"></textarea>
			</div>
		</div>
		<div class="row cl">
